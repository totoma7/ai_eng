...
| 부록 | [07-자바-프레임워크-비교.md](07-자바-프레임워크-비교.md) | 진화 단계별 차이를 LangChain4j vs Spring AI 코드로 비교 — 같은 시나리오 3단계 구현, 흐름 차이 |
| 심화 | [08-하네스-엔지니어링-심화.md](08-하네스-엔지니어링-심화.md) | Agent = Model + Harness, 5계층, 구속 제약 논제, 메트릭, MCP/A2A |
| 심화 | [09-에이전트-Evals-설계.md](09-에이전트-Evals-설계.md) | 5단계 설계법, 60/30/10 채점기 믹스, 하네스 evals, 도구 지형 |
| 심화 | [10-멀티-에이전트-감독.md](10-멀티-에이전트-감독.md) | 스웜의 후퇴, 수퍼바이저 패턴, PEV 루프, Reasoning Sandwich |
| 심화 | [11-Human-in-the-Loop.md](11-Human-in-the-Loop.md) | HiL-Bench, ask_human() 설계, in/on/above-the-loop |
| 심화 | [12-환경-엔지니어링.md](12-환경-엔지니어링.md) | AI-legible 시스템, Orientation Tax, 자기 개선 하네스, 총정리 |
